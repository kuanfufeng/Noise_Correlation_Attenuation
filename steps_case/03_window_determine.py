...
noise_pd = pd.read_csv(noise_fn)
noise_qt = np.zeros(len(noise_pd))
noise_qt = noise_pd["qt005"]
...
ftxt = "NOISE_WINDOW_"+sta_pair+".txt"
f0 = open(ftxt, "w")

line = "ENV,Fband_(Hz),Noise_qt5,Amp(et),window_bt,window_et,file_name\n"
f0.write(line)
